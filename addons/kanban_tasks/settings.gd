		...
		match(what):
			NOTIFICATION_THEME_CHANGED:
				if is_instance_valid(cent):
					var stylebox_n = button.get_theme_stylebox("normal").duplicate()
					stylebox_n.border_width_top = 1
					stylebox_n.border_width_bottom = 1
					stylebox_n.border_width_left = 1
					stylebox_n.border_width_right = 1
					stylebox_n.border_color = Color8(32, 32, 32, 255)
					
					var stylebox_hp = button.get_theme_stylebox("read_only", "LineEdit").duplicate()
					stylebox_hp.border_width_top = 1
					stylebox_hp.border_width_bottom = 1
					stylebox_hp.border_width_left = 1
					stylebox_hp.border_width_right = 1
		...
		match(what):
			NOTIFICATION_THEME_CHANGED:
				if is_instance_valid(add):
					var stylebox_n = add.get_theme_stylebox("normal").duplicate()
					stylebox_n.border_width_top = 1
					stylebox_n.border_width_bottom = 1
					stylebox_n.border_width_left = 1
					stylebox_n.border_width_right = 1
					...
					var stylebox_hp = add.get_theme_stylebox('read_only', 'LineEdit').duplicate()
					stylebox_hp.border_width_top = 1
					stylebox_hp.border_width_bottom = 1
					stylebox_hp.border_width_left = 1
					stylebox_hp.border_width_right = 1
	...
	match(what):
		NOTIFICATION_THEME_CHANGED:
			...
			if is_instance_valid(column_add):
				var stylebox_n = column_add.get_theme_stylebox("normal").duplicate()
				stylebox_n.border_width_top = 1
				stylebox_n.border_width_bottom = 1
				stylebox_n.border_width_left = 1
				stylebox_n.border_width_right = 1
				...
				var stylebox_hp = column_add.get_theme_stylebox("read_only", "LineEdit").duplicate()
				stylebox_hp.border_width_top = 1
				stylebox_hp.border_width_bottom = 1
				stylebox_hp.border_width_left = 1
				stylebox_hp.border_width_right = 1
