...
func popup_at_local_position(source: CanvasItem, local_position: Vector2):
	popup_at_global_position(source, source.get_global_transform() * local_position)


func popup_at_global_position(source: CanvasItem, global_position: Vector2):
...
func popup_at_mouse_position(source: CanvasItem):
	popup_at_global_position(source, source.get_global_mouse_position())


func __update_items_from_board():
	clear()
	size = Vector2i.ZERO
